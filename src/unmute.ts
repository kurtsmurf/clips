...
export function unmute(
  ...
  function removeEventListeners(
    ...
    for (let i: number = 0; i < events.length; ++i) {
      target.removeEventListener(
        events[i],
        handler,
        <any> { capture: capture, passive: passive },
      );
    }
  }
  ...
  function updatePlaybackState(): void {
    ...
    let shouldAllowPlayback: boolean = (allowBackgroundPlayback || ( // always be active if noPause is indicated
   ...
   */
  let silence: string = "data:audio/mpeg;base64,//uQx" + huffman(23, "A") +
    "WGluZwAAAA8AAAACAAACcQCA" + huffman(16, "gICA") + huffman(66, "/") +
    "8AAABhTEFNRTMuMTAwA8MAAAAAAAAAABQgJAUHQQAB9AAAAnGMHkkI" +
    huffman(320, "A") + "//sQxAADgnABGiAAQBCqgCRMAAgEAH" + huffman(15, "/") +
